...
public class BusinessCode {
        // --- USER ---
        public static final String VALID_USER_PSEUDO_BLANK = "validation.user.pseudo.blank";
        ...
        public static final String VALID_USER_PHONE_INVALID = "validation.user.phone.invalid";
        ...
        public static final String VALID_USER_POSTALCODE_INVALID = "validation.user.postalcode.invalid";
